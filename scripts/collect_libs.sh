...
lib_files=(
    ...
    # ONNX
    # $ROOT_DIR/home/root/osrt-build/workarea/onnxruntime/build/Linux/Release/libonnxruntime.so.1.14.0
    ...
    $ROOT_DIR/home/root/osrt-build/workarea/onnx-1.14.0-ubuntu22_aarch64.tar.gz
    # TFLite
    # $ROOT_DIR/home/root/osrt-build/workarea/tensorflow/tflite_build/libtensorflow-lite.a
    ...
    $ROOT_DIR/home/root/osrt-build/workarea/tflite-2.12-ubuntu22_aarch64.tar.gz
    # DLR
